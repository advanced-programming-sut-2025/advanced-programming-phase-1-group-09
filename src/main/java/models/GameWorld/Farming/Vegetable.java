...
public class Vegetable extends Item implements Edible, Collectable {
    private final int gainedEnergy;

    public Vegetable(String name, boolean isStackable, int price, int gainedEnergy) {
    ...
    @Override
    public Vegetable clone() {return new Vegetable(name,isStackable,price,gainedEnergy);}
}
